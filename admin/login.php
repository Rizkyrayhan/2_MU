...
<head>
    ...
    <title>Admin Login - 6R Laundry</title>
    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-12">
        <div class="max-w-md w-full">
            ...
            <div class="text-center mb-8 fade-in">
                ...
                <p class="text-gray-400 mt-2">6R Laundry Management System</p>
            </div>
                ...
                <form action="../api/login.php" method="POST" data-validate>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="email" name="email" required
                               ...
                               placeholder="admin@6rlaundry.com">
                    </div>
            ...
            <!-- Demo Credentials -->
            <div class="mt-6 bg-gray-800 bg-opacity-50 backdrop-blur-sm rounded-lg p-4 text-white text-sm">
                <p class="font-semibold mb-2"><i class="fas fa-info-circle mr-2"></i> Demo Admin:</p>
                <p>Email: admin@6rlaundry.com</p>
